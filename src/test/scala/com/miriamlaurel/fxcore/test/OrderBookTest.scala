...
import com.miriamlaurel.fxcore.market.{Quote, OrderBook}
...
class OrderBookTest extends FunSuite with Matchers {
  ...
  private val snapshot = OrderBook("1273787999996,EUR/USD,BIDS,1.25208,1000000,1.25212,2000000,1.25213,1000000,1.2522,1000000,1.2523,1000000,ASKS,1.2524,1000000,1.25246,1000000")
